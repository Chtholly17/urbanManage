...
Page({
    ...
    showType(e) {
        ...
        if (e.currentTarget.dataset['name'] == '图书角') {
            ...
            that.data.listType[0].arr[0].showSn = !that.data.listType[0].arr[0].showSn
        ...
        if (e.currentTarget.dataset['name'] == '流浪天堂') {
            that.data.listType[0].showSn = !that.data.listType[0].showSn
            that.data.listType[0].showEr = !that.data.listType[0].showEr
            that.data.listType[0].arr[2].showSn = !that.data.listType[0].arr[2].showSn
            console.log(that.data.listType[0])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '跳蚤市场') {
            that.data.listType[0].showSn = !that.data.listType[0].showSn
            that.data.listType[0].showEr = !that.data.listType[0].showEr
            that.data.listType[0].arr[1].showSn = !that.data.listType[0].arr[1].showSn
            console.log(that.data.listType[0])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '观果类') {
            ...
            that.data.listType[1].showEr = !that.data.listType[1].showEr
            that.data.listType[1].arr[0].showSn = !that.data.listType[1].arr[0].showSn
            console.log(that.data.listType[1])
            this.setData({
                listType: that.data.listType
            })
            return
        }
        if (e.currentTarget.dataset['name'] == '观花类') {
            that.data.listType[1].showSn = !that.data.listType[1].showSn
            that.data.listType[1].showEr = !that.data.listType[1].showEr
            that.data.listType[1].arr[1].showSn = !that.data.listType[1].arr[1].showSn
            console.log(that.data.listType[1])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '观叶类') {
            that.data.listType[1].showSn = !that.data.listType[1].showSn
            that.data.listType[1].showEr = !that.data.listType[1].showEr
            that.data.listType[1].arr[2].showSn = !that.data.listType[1].arr[2].showSn
            console.log(that.data.listType[1])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '运动类') {
            that.data.listType[2].showEr = !that.data.listType[2].showEr
            // that.data.listType[2].showEr = false
            let listType = that.data.listType
            this.setData({
                listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '传统健身区') {
            that.data.listType[2].showSn = !that.data.listType[2].showSn
            that.data.listType[2].showEr = !that.data.listType[2].showEr
            that.data.listType[2].arr[0].showSn = !that.data.listType[2].arr[0].showSn
            console.log(that.data.listType[2])
            this.setData({
                listType: that.data.listType
            })
            return
        }
        if (e.currentTarget.dataset['name'] == '新型潮玩区') {
            that.data.listType[2].showSn = !that.data.listType[2].showSn
            that.data.listType[2].showEr = !that.data.listType[2].showEr
            that.data.listType[2].arr[1].showSn = !that.data.listType[2].arr[1].showSn
            console.log(that.data.listType[2])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '阳光运动区') {
            that.data.listType[2].showSn = !that.data.listType[2].showSn
            that.data.listType[2].showEr = !that.data.listType[2].showEr
            that.data.listType[2].arr[2].showSn = !that.data.listType[2].arr[2].showSn
            console.log(that.data.listType[2])
            this.setData({
                listType: that.data.listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '娱乐类') {
            that.data.listType[3].showEr = !that.data.listType[3].showEr
            // that.data.listType[3].showEr = false
            let listType = that.data.listType
            this.setData({
                listType
            })
        ...
        if (e.currentTarget.dataset['name'] == '老年棋牌区') {
            that.data.listType[3].showSn = !that.data.listType[3].showSn
            that.data.listType[3].showEr = !that.data.listType[3].showEr
            that.data.listType[3].arr[0].showSn = !that.data.listType[3].arr[0].showSn
            console.log(that.data.listType[3])
            this.setData({
                listType: that.data.listType
            })
            return
        }
        if (e.currentTarget.dataset['name'] == '幼儿滑梯区') {
            that.data.listType[3].showSn = !that.data.listType[3].showSn
            that.data.listType[3].showEr = !that.data.listType[3].showEr
            that.data.listType[3].arr[1].showSn = !that.data.listType[3].arr[1].showSn
            console.log(that.data.listType[3])
            this.setData({
                listType: that.data.listType
            })
    ...
    onClick(e) {
        ...
        for (var i = 0; i < listType.length; ++i) {
            listType[i].showSn = false
            listType[i].showEr = false
            for (var j = 0; j < listType[i].arr.length; ++j)
                listType[i].arr[j].showSn = false
        }
        this.setData({
